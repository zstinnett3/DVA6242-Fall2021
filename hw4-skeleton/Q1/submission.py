...
def author():                                                                                             
        return "zstinnett3" # replace gburdell3 with your Georgia Tech username.
                                                                                              
def gtid():                                                                                               
    return 902281371 # replace with your GT ID number
