...
class LinearRegressionModel():
    ...
    def lgTrainAccuracy(self, y_train, y_predict_train):
        ...
        # return: float
        # -------------------------------
        preds = np.where(y_predict_train >= 0.5, 1, 0)
    ...
    def lgTestAccuracy(self, y_test, y_predict_test):
        ...
        # return: float
        # -------------------------------
        preds = np.where(y_predict_test >= 0.5, 1, 0)
...
# Q3.4.2 Classification
    ...
    def SVMBestScore(self, scaled_x_train, y_train):
        ...
        svc.fit(scaled_x_train, y_train)
        svm_cv = GridSearchCV(estimator=svc, param_grid=svm_parameters, return_train_score=True, n_jobs=-1)
